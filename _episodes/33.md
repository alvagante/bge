...
description: "Un tuffo nel passato delle telecomunicazioni, dove parliamo di BBS,\
  ...
  \ e storie sul mondo Fidonet e la possibilità di accedere direttamente via Web\n\
  \nLa prima parte della live è qui: https://www.youtube.com/watch?v=3X50y-RpirA"
duration: 6921
youtube: WEY7zmFV33o
tags:
- EvoluzioneModem
...
- "Evoluzione dei modem: Dagli accoppiatori acustici ai primi modem Hayes, la tecnologia\
  \ dei modem è passata dall'essere macchinosi e manuali a dispositivi che permettevano\
...
- 'FidoNet e la telematica in Italia: FidoNet, una delle prime reti di comunicazione
  ...
  specifici.'
- "Diffusione di FidoNet: La rete è cresciuta rapidamente in Italia grazie all'apertura\
  \ di nodi locali, facilitando la creazione di una comunità telematica ben prima\
...
- "Impatto sociale e culturale della telematica: Oltre agli aspetti tecnologici, la\
  \ telematica e reti come FidoNet hanno avuto un forte impatto sulla società,\
...
- "Regolamentazioni e normative: Le leggi e le regolamentazioni italiane hanno seguito\
  \ con difficoltà l'evoluzione tecnologica, spesso risultando in un contesto complicato\
...
quote_claude: "\"Prima di Internet eravamo pionieri digitali che trasmettevano bit\
  \ di libertà attraverso linee analogiche\" \n"
...
quote_deepseek: "\"Prima di Internet, ribelli con modem urlanti e cablaggi clandestini:\
  \ il '94 ci silenziò, ma la resistenza digitale vive negli echi del dial-up.\"\
  \n"
quote_llama: "\"La libertà di connessione è la scintilla che accende la rivoluzione\
  \ delle idee.\""
quote_deepseek_reasoning: "Okay, let's tackle this. The user wants a short, impactful\
  ...
  \ e cablaggi clandestini. Il '94 ci silenziò, ma la resistenza digitale sopravvive\
  \ negli echi del dial-up.\"\n\nCheck character count: Let's see... \"Prima di Internet,\
  \ ribelli con modem urlanti e cablaggi clandestini: il '94 ci silenziò, ma la\
  ...
  \ clandestini: il '94 ci silenziò, ma la resistenza digitale vive negli echi\
  \ del dial-up.\"\n"
claude_article: "Nel crepuscolo digitale degli anni '80 e '90, prima che Internet\
  \ diventasse l'ossatura della nostra società interconnessa, esisteva un mondo\
  ...
  \ la comunità delle BBS italiane. È la storia di come la paura dell'ignoto\
  \ tecnologico abbia portato a decisioni che hanno rischiato di soffocare l'innovazione\
  \ digitale nel nostro paese.\n\nMa è anche una narrazione di resilienza e ingegno:\
  \ dai primi nodi FidoNet (1:33/1, poi 2:33/1) alle soluzioni creative per aggirare\
  \ le limitazioni hardware e legali dell'epoca. È la cronaca di una rivoluzione\
