...
quote_openai: "\"Nel caos del cloud, l'arte di risparmiare \xE8 la vera ribellione.\"\
  \n"
quote_deepseek: "\"Nuvole scolpite, non sprechi: nel cloud ogni byte \xE8 oro sepolto\
  \ da disotterrare.\"\n"
...
quote_deepseek_reasoning: "Okay, I need to create a short, impactful quote based on\
  ...
  \ cloud ogni byte \xE8 un tesoro sepolto.\" Let me check the character count. \"\
  Scolpiamo nuvole, non sprechi: nel cloud ogni byte \xE8 un tesoro sepolto.\" That's\
  ...
  \ non sprechi: nel cloud ogni byte \xE8 oro sepolto da disotterrare.\"\n"
