...
quote_openai: "\"In un mondo che corre, l'agilit\xE0 \xE8 il battito di un cuore imprenditoriale.\"\
  \n"
quote_deepseek: "\"Agilit\xE0: non sopravvivere al caos, ballarne il ritmo.\"\n"
...
quote_deepseek_reasoning: "Okay, let's tackle this. The user wants a short, impactful\
  ...
  \ Use strong, short words. In Italian, \"agilit\xE0\" is key. Maybe something like\
  \ \"Nella velocit\xE0 del mercato, solo chi danza nel caos non cade.\" (In the speed\
  \ of the market, only those who dance in chaos don't fall.) Check character count.\
  \ Let's see: \"Agilit\xE0 \xE8 il ritmo segreto: ballare il caos, non sopravvivergli.\"\
  \ (Agility is the secret rhythm: dance chaos, not survive it.) That's 71 characters.\
  \ Maybe better. Alternatively, \"Agilit\xE0: non sopravvivere al caos, ballarne\
